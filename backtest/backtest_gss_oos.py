...
DATA_START, TRADE_START, END = "2005-06-01", "2007-01-01", "2020-01-01"
...
WINDOWS = [("2008 GFC", "2007-10-01", "2009-06-30"),
           ...
           ("FULL 2007-2019", TRADE_START, END)]
...
def main():
    ...
    print(f"OUT-OF-REGIME (developed on 2020-26). last-trading-day rebalance, net@{COST}bps")
